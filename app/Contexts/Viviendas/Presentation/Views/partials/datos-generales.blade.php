...
<div>
    ...
    <div class="mt-1.5">
        <x-shared::form.text-input id="fraccionamiento" type="text" wire:model="fraccionamiento" placeholder="ej: Residencial del Bosque" />
    </div>
...
<div>
    ...
    <div class="mt-1.5">
        <x-shared::form.input-select id="estatus_vivienda" wire:model="estatus_vivienda" :messages="$errors->get('estatus_vivienda')" >
