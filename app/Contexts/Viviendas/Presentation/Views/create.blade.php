        ...
        <form wire:submit="save">
            ...
            >
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    {{-- Fraccionamiento --}}
                    <div>
                        <x-shared::form.input-label for="fraccionamiento" :value="__('Fraccionamiento / Proyecto')"/>
                        <div class="mt-1.5">
                        ...
                        <div class="space-y-4">
                            @foreach($contactos as $index => $contacto)
                                <div class="grid grid-cols-1 md:grid-cols-12 gap-3 p-4 border border-gray-200 dark:border-gray-800 bg-gray-50/30 dark:bg-gray-900/10 relative rounded-none" wire:key="contacto-row-{{ $index }}">
                                    ...
                                    {{-- Nombre Completo (Actualizado a text-input) --}}
                                    <div class="md:col-span-3">
                                    ...
                                    {{-- Relación / Vínculo (Actualizado a text-input) --}}
                                    ...
                                    {{-- Teléfono (Actualizado a text-input) --}}
                                    <div class="md:col-span-2">
                                    ...
                                    {{-- Correo Electrónico (Actualizado a text-input) --}}
                                    <div class="md:col-span-2">
                                    ...
                                    {{-- Notas Cortas (Actualizado a text-input) --}}
                                    <div class="md:col-span-2">
                ...
                <x-slot:footer>
                    <div class="flex items-center justify-between">
                        ...
                        <x-shared::form.button-primary type="submit" class="shadow-lg px-5 h-11 text-xs" wire:loading.attr="disabled" wire:target="save">
                            <i class="fa-solid fa-floppy-disk mr-2" wire:loading.remove wire:target="save"></i>
