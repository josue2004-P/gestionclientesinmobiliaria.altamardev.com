...
class SaveClienteRequest extends FormRequest
{
    ...
    {
        $clienteId = $this->route('id') ?? $this->cliente_id ?? null;
        ...
        return [
            ...
            'curp'                 => 'nullable|string|max:18|unique:clientes,curp,' . $clienteId,
    ...
    public function messages(): array
    {
        return [
            ...
            // Especificaciones de referencias
