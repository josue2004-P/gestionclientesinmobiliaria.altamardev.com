...
<div 
    x-data="{
        ...
        init() {
            ...
            // Detecta si Livewire o Blade cambian dinámicamente los <option> del slot
        ...
        get selectedLabel() {
            ...
            return selected ? selected.label : '{{ $placeholder ?? 'Seleccionar opción' }}';
        }
    }"
...
>
    {{-- SELECT OCULTO (Paso de datos nativo/slot) --}}
    ...
    {{-- TRIGGER / BOTÓN PRINCIPAL (Idéntico a text-input) --}}
    <div 
        @click="toggle()"
    ...
    {{-- MENÚ DESPLEGABLE CON ESTILOS EXACTOS DE SEARCHABLE-SELECT --}}
    <div 
        x-show="open" 
        x-cloak
