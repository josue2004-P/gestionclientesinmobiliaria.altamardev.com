...
<body x-data="{ isFiltersOpen: false }" class="bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 antialiased selection:bg-indigo-600 selection:text-white flex flex-col min-h-screen transition-colors duration-200">

    <!-- HEADER (Landing de Catálogo Integrado) -->
    <header class="sticky top-0 z-40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-200/80 dark:border-slate-800 transition-colors duration-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3 sm:gap-4">
                ...
                <!-- BOTÓN PARA ABRIR FILTROS EN MÓVIL (VISIBLE SOLO EN < lg) -->
                <button @click="isFiltersOpen = true" 
                        type="button" 
                        class="lg:hidden flex items-center gap-2 bg-indigo-50 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-900/50 font-bold px-3 py-2 rounded-xl text-xs transition">
                ...
                <button
                    class="relative flex items-center justify-center text-slate-500 transition-colors bg-white border border-slate-200 rounded-full h-10 w-10 hover:bg-slate-100 hover:text-slate-700 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-white shadow-sm"
    ...
    <!-- BACKDROP / TELÓN OSCURO EN MÓVIL AL ABRIR FILTROS -->
    ...
    <!-- BOTÓN FLOTANTE MÓVIL PARA FILTROS (BOTTOM-RIGHT) -->
    <button @click="isFiltersOpen = true"
            type="button"
            class="lg:hidden fixed bottom-6 left-6 z-40 bg-indigo-600 hover:bg-indigo-700 text-white font-bold px-4 py-3 rounded-full shadow-lg flex items-center gap-2 text-xs uppercase tracking-wider">
        <i class="fa-solid fa-sliders"></i>
        <span>Filtros</span>
    </button>
